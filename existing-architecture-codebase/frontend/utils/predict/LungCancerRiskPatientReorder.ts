// frontend/src/utils/LungCancerRiskPatientReorder.ts

export type PatientRecord = Record<string, any>;

export class LungCancerRiskPatientReorder {
  ...
  static reorder(data: PatientRecord): PatientRecord {
    ...
    // 2. Append any extra fields at the end (like Lung_Cancer, metadata, etc.)
