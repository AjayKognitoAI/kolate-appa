...
const components = (theme: Theme, isCardShadow: boolean): Components | any => {
  ...
  return {
    ...
    MuiButton: {
      styleOverrides: {
        outlined: {
          border: "1px solid #D0D5DD", // 🔹 soft gray border
          color: "#344054", // 🔹 text color (dark gray)
          backgroundColor: "#fff", // 🔹 white background
          "&:hover": {
            backgroundColor: "#F9FAFB", // 🔹 light hover background
            border: "1px solid #BDBDBD", // 🔹 slightly darker border on hover
          },
          "&:disabled": {
            color: "#BDBDBD",
